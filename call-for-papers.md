...
### Original call (for reference)

This year, we invited two types of submissions:
...
Submissions of full papers were required to nominate one author to assist with the peer review of submitted works. Nominated reviewers were asked to review up to three papers.
...
If your organisation would like to sponsor the conference, please contact [meeting@uk-ai.org](mailto:meeting@uk-ai.org). We welcome contributions of any amount.
