...
start_time: 2026-09-30 10:50
end_time: 2026-09-30 11:30
location:
...
| :---: | :--- | :--- | :--- |
| 46 | Time Series Analysis of Salmonid Harvest in Lake Lugano Using Machine Learning | Charles Olisaemeka Ejete | University of Hull |
...
| 50 | Mask-conditioned synthetic prostate MRI volumes using a denoising diffusion probabilistic model | Chibike Ugbam | University of Stirling |
...
| 54 | Do Linguistic Features Matter When Comparing Humans and LLM Markers? Evidence From Human and LLM Assessment of University Essays | Maryam Abo-Tabik | University of Lancashire |
| 55 | From Scales to Sale: Computer Vision for Exotic Reptile Leather Identification in Fashion Imagery | Natalie Fang | University College London |
| 56 | Within-Species Individual Identification of Lacertid Reptiles Using Museum Specimen Collections | Kevin Wang | Imperial College London |
| 57 | Tokens to Terrains: Quantifying How Word Embeddings Steer Spatial Probability in Zoonotic Disease Reservoir Mapping | Adeshola Okubena | The Natural History Museum |
...
| 65 | THRIVE: Recursive Multi-Agent LLM Throughput Optimization | Sicheng Zhao | Tsinghua University |
